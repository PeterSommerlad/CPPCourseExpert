...
Note: if you do not have the boost libraries installed, use my header only counter iterator library available as [range_counter.h](https://github.com/PeterSommerlad/CPPCourseAdvanced/raw/main/exercises/exercise05/solutions/range_counter.h) or as 
