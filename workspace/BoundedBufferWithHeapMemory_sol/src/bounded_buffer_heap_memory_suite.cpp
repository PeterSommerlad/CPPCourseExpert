...
struct AllocationTracker {
	static void* operator new(std::size_t sz) {
        AllocationTracker *const ptr = static_cast<AllocationTracker*>(::operator new(sz));
    ...
    static void *operator new(std::size_t sz, AllocationTracker* ptr) {
	   std::ignore = ::operator new(sz, ptr);
	   allocatedSingleObjects.push_back(ptr);
	   return ptr;
    }


	static inline std::vector<AllocationTracker*> allocatedSingleObjects;
	static inline std::vector<AllocationTracker*> allocatedArrays;
	static inline std::vector<AllocationTracker*> deallocatedSingleObjects;
	static inline std::vector<AllocationTracker*> deallocatedArrays;
};
