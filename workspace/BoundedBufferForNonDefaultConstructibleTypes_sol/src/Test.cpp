...
void runAllTests(int argc, char const *argv[]) {
	...
	cute::makeRunner(lis,argc,argv)(make_suite_bounded_buffer_non_default_constructible_element_type_suite(), "BoundedBuffer Non-Default Constructible Element Tests");
}
