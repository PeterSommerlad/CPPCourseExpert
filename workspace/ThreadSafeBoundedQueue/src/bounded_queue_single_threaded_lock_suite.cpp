...
void test_push_rvalue_acquires_lock() {
...
void test_push_lvalue_acquires_lock() {
	int i { 1 };
	BoundedQueue<int, single_threaded_test_mutex, single_threaded_condition_variable<1, 1>> queue { 5 };
	reset_counters();
...
void test_swap_acquires_both_locks() {
	BoundedQueue<int, single_threaded_test_mutex, single_threaded_condition_variable<0,4>> queue { 5 }, other { 4 };
	queue.push(1); // non-empty and non-full
	other.push(2); // non-emptu and non-full
	reset_counters();
...
void test_swap_releases_two_locks() {
	BoundedQueue<int, single_threaded_test_mutex, single_threaded_condition_variable<0,2>> queue { 5 }, other { 4 };
	reset_counters();
...
void test_swap_acquires_tries_multiple_times_to_try_lock() {
	BoundedQueue<int, single_threaded_count_down_mutex<3>, single_threaded_condition_variable<0,2>> queue { 5 }, other { 4 };
	reset_counters();

	queue.swap(other);

	ASSERT_LESS_EQUAL(4, single_threaded_test_mutex::try_lock_count);
}

void test_swap_successful_after_delayed_lock() {
	BoundedQueue<int, single_threaded_count_down_mutex<1>, single_threaded_condition_variable<1, 4>> queue { 5 }, other { 4 };
	other.push(17);
	reset_counters();
...
void test_try_push_rvalue_acquires_lock() {
...
void test_try_push_lvalue_acquires_lock() {
	int i { 1 };
	BoundedQueue<int, single_threaded_test_mutex, single_threaded_condition_variable<0, 1>> queue { 5 };
	reset_counters();
...
void test_try_pop_acquires_lock() {
	BoundedQueue<int, single_threaded_test_mutex, single_threaded_condition_variable<0, 1>> queue { 5 };
	queue.push(1);
	int result { };
	reset_counters();
...
void test_symmetric_lock_and_unlock_on_copy_constructor() {
	...
	BoundedQueue<int, single_threaded_test_mutex, single_threaded_condition_variable<0, 0>> copy { queue };
...
void test_symmetric_lock_and_unlock_on_move_constructor() {
	...
	BoundedQueue<int, single_threaded_test_mutex, single_threaded_condition_variable<0, 0>> moved { std::move(queue) };
...
void test_symmetric_lock_and_unlock_on_move_assignment() {
	BoundedQueue<int, single_threaded_test_mutex, single_threaded_condition_variable<0, 2>> queue { 5 }, moved { 4 };
	reset_counters();
...
void test_try_push_for_acquires_lock_on_empty_queue() {
	int i { 1 };
	BoundedQueue<int, single_threaded_test_mutex, single_threaded_condition_variable<1, 1>> queue { 5 };
	reset_counters();
...
void test_try_pop_for_acquires_lock_on_empty_queue() {
	int result { };
...
void test_try_push_for_acquires_lock_on_full_queue() {
...
void test_try_pop_for_acquires_lock_on_full_queue() {
	int result { };
	BoundedQueue<int, single_threaded_test_mutex, single_threaded_condition_variable<1, 0>> queue { 1 };
	queue.push(1);
	reset_counters();
...
cute::suite make_suite_bounded_queue_single_threaded_lock_suite() {
	cute::suite s;
	s.push_back(CUTE(test_push_rvalue_acquires_lock));
	s.push_back(CUTE(test_push_rvalue_releases_lock));
	s.push_back(CUTE(test_push_lvalue_acquires_lock));
	s.push_back(CUTE(test_push_lvalue_releases_lock));
	s.push_back(CUTE(test_pop_acquires_lock));
	s.push_back(CUTE(test_pop_releases_lock));
	s.push_back(CUTE(test_empty_acquires_lock));
	s.push_back(CUTE(test_empty_releases_lock));
	s.push_back(CUTE(test_full_acquires_lock));
	s.push_back(CUTE(test_full_releases_lock));
	s.push_back(CUTE(test_size_acquires_lock));
	s.push_back(CUTE(test_size_releases_lock));
	s.push_back(CUTE(test_swap_acquires_both_locks));
	s.push_back(CUTE(test_swap_releases_two_locks));
	s.push_back(CUTE(test_try_push_rvalue_acquires_lock));
	s.push_back(CUTE(test_try_push_rvalue_releases_lock));
	s.push_back(CUTE(test_try_push_lvalue_acquires_lock));
	s.push_back(CUTE(test_try_push_lvalue_releases_lock));
	s.push_back(CUTE(test_try_pop_acquires_lock));
	s.push_back(CUTE(test_try_pop_releases_lock));
	s.push_back(CUTE(test_swap_acquires_tries_multiple_times_to_try_lock));
	...
	s.push_back(CUTE(test_try_push_for_acquires_lock_on_empty_queue));
	s.push_back(CUTE(test_try_push_for_releases_lock_on_empty_queue));
	s.push_back(CUTE(test_try_pop_for_acquires_lock_on_empty_queue));
	s.push_back(CUTE(test_try_pop_for_releases_lock_on_empty_queue));
	s.push_back(CUTE(test_try_push_for_acquires_lock_on_full_queue));
	s.push_back(CUTE(test_try_push_for_releases_lock_on_full_queue));
	s.push_back(CUTE(test_try_pop_for_acquires_lock_on_full_queue));
